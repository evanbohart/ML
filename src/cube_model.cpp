...
namespace model
{
    ...
    {
        f.bitboard = utils::roll_right(f.bitboard, 16);
    }

    void cube::turn_face_counterclockwise(face &f)
    {
        f.bitboard = utils::roll_left(f.bitboard, 16);
    }
    ...
    void cube::turn(const move &m)
    {
        ...
        switch (m) {
            case L:
                ...
                faces[3].bitboard |= utils::roll_right(faces[5].bitboard & ~MASK_OUT_R, 32);
                faces[5].bitboard &= MASK_OUT_R;
                faces[5].bitboard |= utils::roll_right(faces[2].bitboard & ~MASK_OUT_L, 32);
            ...
            case LPRIME:
                ...
                faces[2].bitboard &= MASK_OUT_L;
                faces[2].bitboard |= utils::roll_right(faces[5].bitboard & ~MASK_OUT_R, 32);
                faces[5].bitboard &= MASK_OUT_R;
                faces[5].bitboard |= utils::roll_right(faces[3].bitboard & ~MASK_OUT_L, 32);
                faces[3].bitboard &= MASK_OUT_L;
            ...
            case R:
                ...
                faces[2].bitboard |= utils::roll_right(faces[5].bitboard & ~MASK_OUT_L, 32);
                faces[5].bitboard &= MASK_OUT_L;
                faces[5].bitboard |= utils::roll_right(faces[3].bitboard & ~MASK_OUT_R, 32);
            ...
            case RPRIME:
                ...
                faces[3].bitboard &= MASK_OUT_R;
                faces[3].bitboard |= utils::roll_right(faces[5].bitboard & ~MASK_OUT_L, 32);
                faces[5].bitboard &= MASK_OUT_L;
                faces[5].bitboard |= utils::roll_right(faces[2].bitboard & ~MASK_OUT_R, 32);
                faces[2].bitboard &= MASK_OUT_R;
            ...
            case D:
                ...
                faces[2].bitboard |= utils::roll_left(faces[1].bitboard & ~MASK_OUT_L, 16);
                faces[1].bitboard &= MASK_OUT_L;
                faces[1].bitboard |= utils::roll_left(faces[3].bitboard & ~MASK_OUT_T, 16);
                faces[3].bitboard &= MASK_OUT_T;
                faces[3].bitboard |= utils::roll_left(faces[4].bitboard & ~MASK_OUT_R, 16);
                faces[4].bitboard &= MASK_OUT_R;
                faces[4].bitboard |= utils::roll_left(temp & ~MASK_OUT_B, 16);
            ...
            case DPRIME:
                ...
                faces[2].bitboard &= MASK_OUT_B;
                faces[2].bitboard |= utils::roll_right(faces[4].bitboard & ~MASK_OUT_R, 16);
                faces[4].bitboard &= MASK_OUT_R;
                faces[4].bitboard |= utils::roll_right(faces[3].bitboard & ~MASK_OUT_T, 16);
                faces[3].bitboard &= MASK_OUT_T;
                faces[3].bitboard |= utils::roll_right(faces[1].bitboard & ~MASK_OUT_L, 16);
                faces[1].bitboard &= MASK_OUT_L;
                faces[1].bitboard |= utils::roll_right(temp & ~MASK_OUT_B, 16);
            ...
            case U:
                ...
                faces[2].bitboard |= utils::roll_right(faces[4].bitboard & ~MASK_OUT_L, 16);
                faces[4].bitboard &= MASK_OUT_L;
                faces[4].bitboard |= utils::roll_right(faces[3].bitboard & ~MASK_OUT_B, 16);
                faces[3].bitboard &= MASK_OUT_B;
                faces[3].bitboard |= utils::roll_right(faces[1].bitboard & ~MASK_OUT_R, 16);
                faces[1].bitboard &= MASK_OUT_R;
                faces[1].bitboard |= utils::roll_right(temp & ~MASK_OUT_T, 16);
            ...
            case UPRIME:
                ...
                faces[2].bitboard &= MASK_OUT_T;
                faces[2].bitboard |= utils::roll_left(faces[1].bitboard & ~MASK_OUT_R, 16);
                faces[1].bitboard &= MASK_OUT_R;
                faces[1].bitboard |= utils::roll_left(faces[3].bitboard & ~MASK_OUT_B, 16);
                faces[3].bitboard &= MASK_OUT_B;
                faces[3].bitboard |= utils::roll_left(faces[4].bitboard & ~MASK_OUT_L, 16);
                faces[4].bitboard &= MASK_OUT_L;
                faces[4].bitboard |= utils::roll_left(temp & ~MASK_OUT_T, 16);
